...
# Data sets
IRIS_TRAINING = os.path.join(os.path.dirname(__file__), "iris_data/iris_training.csv")
IRIS_TEST = os.path.join(os.path.dirname(__file__), "iris_data/iris_test.csv")
